...
[screenshot of monster GeoJSON]

# Discussion

🙋‍♀️ What tactics have you used to manage your GeoJSON so far?

🙋‍♀️ What kinds of problems have you run into?
...
🙋‍♀️ Why do you think that might be a useful practice?

# Separation of concerns, ctd...
...
When the request is made, your browser does a couple of extra things before determinig whether it should complete the request. 
...
You built a mapping app and put it online at `www.my-sweet-map.com`. When users click on a marker on your map, a popup opens with a picture of the best ice cream in that area. All of the images come from flickr.com.
...
Back to our example. Let's open up the `cwm-geojson-direct.html` file again and look at the request.
...
# Trying out the "javascript hack"

1. To to the folder you've been working in and create a new file called `ports.js`. 
...
# Trying out the "javascript hack," part II

1. Open "cwm-geojson-variable.html"
2. In the head, create a new "script" tag that points to the file you created in the previous slide.
3. Find the spot in the code where the the source for the ports layer is being created and set the value of "data" to the ports variable you created in the previous slide.
...
🙋‍♀️ Can you think of some scenarios where you wouldn't be able to use the "javascript hack?"
...
🙋‍♀️ Who can tell me why we want to serve our files?
